...
<p align="center">
  <img src="https://record-rotate.arkk200.workers.dev/?width=900&title=on&albums=Bewhy:The%20Blind%20Star,Bewhy:The%20Movie%20Star,Bewhy:POP%20IS%20CRYIN%27,Bewhy:In%20Trinity,Bewhy:Dejavu,Bewhy:SOUTHSIDE%20FREESTYLE,Bewhy:Holy%20Toast" alt="Bewhy album covers rotating" />
</p>
...
`albums`는 쉼표로 구분합니다. 최대 7개까지 처리합니다. 앨범명만 넣어도 되지만, 검색 정확도를 위해 `Artist:Album` 또는 `Artist - Album` 형식을 권장합니다. `albums`가 없으면 앨범 커버는 표시하지 않습니다. 위 데모는 서로 다른 비와이 앨범 7장을 사용합니다.
